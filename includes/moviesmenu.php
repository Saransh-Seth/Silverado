...
<div class="col-lg-3 pull-right search">

    <div class="input-group">
      <input type="text" class="form-control" name="searchtext" id="searchtext" placeholder="Search for movies">
      <span class="input-group-btn">
        <button type="button" class="btn btn-primary" id="go" aria-label="Right Align">
